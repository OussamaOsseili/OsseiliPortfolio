              ...
              {[
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Coursera / Oracle</p>
                  </div>
                </a>
              ))}
            </div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {t.about.languages.items.map((lang, index) => (
                <div
                  key={index}
                  className="text-center p-4 rounded-lg hover:bg-muted/50 transition-colors bg-sidebar-border shadow-xl"
                >
